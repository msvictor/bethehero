...
<h1 align="center">
    <img alt="Login" src="../assets/web_signin.png" width="40%">
    <img alt="Cadastro" src="../assets/web_signup.png" width="40%">
    <img alt="Lista de Casos" src="../assets/web_case_list.png" width="40%">
    <img alt="Cadastrar Caso" src="../assets/web_new_case.png" width="40%">    
</h1>
